...
SECRET_KEY = 'django-insecure-+@jy@nczkrq)7*m-!)7xfnvqz&!*cl5q3r_w#s19=!os2yfqyn'
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'valerian-hizkia-footballnews.pbp.cs.ui.ac.id', '10.0.2.2']
